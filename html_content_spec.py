...
The spec is based on the HTML spec:
...
Note 2: some tags have special rules that need additional context
        (attributes, html structure, etc)
...
'''
    Categories can be seen as groups that the tag belong to
        and/or as list of valid parent tags
    content_model: what the tag expect its descendant tags to be,
...
content_spec = {"p":
                ...
                "link":
                    {
                        # has special categories depending on attribute as well
                        "categories": ["metadata"],
                        "content_model": [_NO_CONTENT]
                    },
                "title":
